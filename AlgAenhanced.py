...
class TSPSolver:
    ...
    def heuristic(self, state):
        ...
        if tuple(state) in self.heuristic_cache:
            return self.heuristic_cache[tuple(state)]
        ...
        mst_cost = self.calculate_mst_cost(tour)
        estimated_cost += mst_cost
        self.heuristic_cache[tuple(state)] = estimated_cost
